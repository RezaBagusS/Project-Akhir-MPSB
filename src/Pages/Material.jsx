        ...
        <div className="col-span-4 flex flex-col h-[85vh] gap-y-3 px-4 pr-5">
          <div className="flex flex-col gap-y-1">
            <div>
                ...
                {
                    isDownMateri && 
                    <div className="flex flex-col gap-y-1 mt-1 mb-3 justify-center overflow-hidden">
                        <div className="w-11/12 mx-auto pl-3 pr-3 py-2 text-base font-medium rounded-md bg-gray-400 text-white">Pendahuluan</div>
                        <div className="w-11/12 mx-auto pl-3 pr-3 py-2 text-base font-medium rounded-md bg-gray-400 text-white">Profesi dalam Pengembangan Website</div>
                        <div className="w-11/12 mx-auto pl-3 pr-3 py-2 text-base font-medium rounded-md bg-gray-400 text-white">Pengenalan Website</div>
                        <div className="w-11/12 mx-auto pl-3 pr-3 py-2 text-base font-medium rounded-md bg-gray-400 text-white">Pengenalan URL</div>
                    </div>
                }
            </div>

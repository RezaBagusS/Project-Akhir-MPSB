  ...
  return (
    <div className="bg-slate-600 h-screen w-3/5 text-cust-beige">
      ...
      <div className="h-[75vh] w-full py-2 font-medium text-md">
        <section className="w-full h-18 px-3 py-2">
          <div className="hover:bg-slate-500 cursor-pointer px-3 py-3 rounded-lg transition-colors duration-300">
            <h3 className="flex items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
                className="w-6 h-6 mr-2 fill-cust-beige"
              >
        ...
        <section className="w-full h-18 px-3 py-2">
          <div className="hover:bg-slate-500 cursor-pointer px-3 py-2 rounded-lg transition-colors duration-300">
            <h3 className="flex items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 640 512"
